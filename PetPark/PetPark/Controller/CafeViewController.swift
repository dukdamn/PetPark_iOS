...
class CafeViewController: UIViewController {
  ...
  private func attribute() {
    ...
    tempCollectionView.register(CafeCollectionViewCell.self, forCellWithReuseIdentifier: CafeCollectionViewCell.identifier)
...
extension CafeViewController: UICollectionViewDataSource {
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CafeCollectionViewCell.identifier, for: indexPath) as! CafeCollectionViewCell
    cell.delegate = self
...
extension CafeViewController: CafeCollectionViewCellDelegate {
