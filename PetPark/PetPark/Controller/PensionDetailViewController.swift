...
//    let addressString = String()
    ...
    let imageString = "pension4"
    let pensionName = "퀸스타운애견펜션"
    let addressString = "경기 양평군 단월면 석산로"
    let siteString = "https://store.naver.com/accommodations/detail?entry=pbl&id=1308339764&matchSidRoomIds=2988453%2C2988422%2C3000735%2C2988463%2C2988503%2C3009782%2C2988514&query=%ED%80%B8%EC%8A%A4%ED%83%80%EC%9A%B4%EC%95%A0%EA%B2%AC%ED%8E%9C%EC%85%98"
    let numString = "01092117741"
    let introduceString = "엘리스 산장 애견 전용 민박 펜션이예요~ 다양한 방이 있으니 홈페이지로 구경오세요~ 손님들에게 계란 무료제공 서비스와 24시간 오픈된 매점 운영을 합니다. 맘껏 뛰고 놀 애견 운동장도 있어요~"
...
//  Pension(name: "퀸스타운애견펜션", location: "경기 양평군 단월면 석산로 1539-10", imageName: "pension4", siteName: "https://store.naver.com/accommodations/detail?entry=pbl&id=1308339764&matchSidRoomIds=2988453%2C2988422%2C3000735%2C2988463%2C2988503%2C3009782%2C2988514&query=%ED%80%B8%EC%8A%A4%ED%83%80%EC%9A%B4%EC%95%A0%EA%B2%AC%ED%8E%9C%EC%85%98", phoneName: "01033695618", pensionDetail: "엘리스 산장 애견 전용 민박 펜션이예요~ 다양한 방이 있으니 홈페이지로 구경오세요~ 손님들에게 계란 무료제공 서비스와 24시간 오픈된 매점 운영을 합니다. 맘껏 뛰고 놀 애견 운동장도 있어요~"),
    ...
    let contentUserImageString = "cafePerson1"
...
//        geocodeAddressString()  //map pin
    ...
    private func setUpUI() {
      ...
      pensionImage.layer.cornerRadius = 10
      pensionImage.layer.masksToBounds = true
