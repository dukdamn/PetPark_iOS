...
extension MyPageViewController: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    case 0:
      ...
      likeCell.tableViewInfo(photoImage: "개", nickName: "iOS App Developer")
...
extension MyPageViewController: UITableViewDelegate {
  func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    ...
    if indexPath.row == 0 {
      ...
      return view.safeAreaLayoutGuide.layoutFrame.height / 3
    }
    return view.safeAreaLayoutGuide.layoutFrame.height / 2.3
  }
...
extension MyPageViewController: MyPageTableViewCellDelegate {
  func whenPickImageButtonDidTap() {
    print("in whenPickImageButtonDidTap")
...
extension MyPageViewController: MyPageCafeTableViewCellDelegate {
  func selectedItem(indexPath: IndexPath) {
    ...
    let cafeDetailVC =  CafeReviewViewController()
...
extension MyPageViewController: MyPagePensionTableViewCellDelegate {
  func selectItem(indexPath: IndexPath) {
    ...
    let pensionDetailVC = PensionReviewViewController()
