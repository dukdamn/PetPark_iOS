...
//  }
//
//  func pensionInfo(pensionName1: String, pensionLocation: String, pensionImageName: String){
//    pensionImageView.image = UIImage(named: pensionImageName)
//    pensionAddress.text =  pensionLocation
//  }
//
//  func penseionItemSet(pensionImage image: String, pensionName name: String, pensionAddress address: String, likeButtonImage likeImage: String) {
...
//
//    [pensionImageView, pensionName, pensionAddress, /*likeButton*/].forEach {
...
//      //            pensionImageView.widthAnchor.constraint(equalToConstant: imageViewHeight),
//      pensionImageView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor),
...
//      //            pensionName.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -(padding * 2 + labelHeight)),
...
//      //            pensionAddress.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -(padding * 2 + labelHeight)),
...
class PensionCollectionViewCell: UICollectionViewCell {
  ...
  private func setUpUI() {
    ...
    let margin: CGFloat = 10
    let padding: CGFloat = 5
    let imageViewHeight: CGFloat = 180
    let labelHeight: CGFloat = 30
    pensionImageView.translatesAutoresizingMaskIntoConstraints = false
    NSLayoutConstraint.activate([
      pensionImageView.topAnchor.constraint(equalTo: contentView.topAnchor),
